        ...
        <div class="col-md-12">
            <div class="panel panel-default"></div>
                <div class="panel-body">
                    ...
                    <form class="needs-validation" novalidate  method="POST" action="{{route('customer.update')}}" id="formvalidate">
                        {{ csrf_field() }}
                    <input type="hidden" class="form-control" id="id" name="id" value="{{$customer ? $customer->id : ''}}">
